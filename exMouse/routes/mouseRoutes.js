...
router.post('/', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to create mouse' });
    }
});

// URI: PUT /api/mouses/:id
router.put('/:id', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to update mouse' });
    }
});

// URI: DELETE /api/mouses/:id
router.delete('/:id', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to delete mouse' });
    }
});
